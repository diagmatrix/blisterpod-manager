...
export default function SettingsPage() {
    ...
    const pageSizeScale = pageSizeFamily(defaultPageSize)
    ...
    const handleSetPageSizeScale = (scale: readonly PageSize[]) => {
        const index = pageSizeScale.indexOf(defaultPageSize)
        handleSetDefaultPageSize(scale[index >= 0 ? index : 0])
    }
                ...
                <div className="flex gap-12 items-start">
                    ...
                    <div className="flex-1 space-y-8">
                        ...
                        >
                            ...
                            <SettingsRow
                                label="Page size scale"
                                description="Which set of page sizes the browse and add pages offer."
                            >
                                <div className="flex rounded-md border overflow-hidden">
                                    {PAGE_SIZE_FAMILIES.map((scale) => (
                                        <button
                                            key={scale.join('-')}
